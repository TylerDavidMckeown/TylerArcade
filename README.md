...
Report bugs via GitHub Issues, suggest new game ideas, or open a Pull Request. Please read [CONTRIBUTING.md](CONTRIBUTING.md) first.
...
Released under the [MIT License](LICENSE). This project is derived from the open-source [tiny-arcade](https://github.com/ShemYu/tiny-arcade) project by ShemYu; see [NOTICE](NOTICE) for attribution.
